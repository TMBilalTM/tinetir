...
export default function SignIn() {
  ...
  return (
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-blue-500 via-blue-600 to-blue-700 items-center justify-center relative overflow-hidden">
        <div className="absolute inset-0 bg-black/20"></div>
        <div className="relative z-10 text-center text-white">
          <div className="text-8xl mb-8 font-bold">𝕏</div>
          <h1 className="text-4xl font-bold mb-4">Dünyada olup bitenler</h1>
          <p className="text-xl opacity-90">Hemen katıl.</p>
        </div>
        {/* Decorative elements */}
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 bg-black">
        <div className="w-full max-w-md">
          ...
          <div className="text-center mb-8">
            <h2 className="text-3xl font-bold text-white mb-2">Twitter&apos;a giriş yap</h2>
          ...
          <div className="bg-blue-900/30 border border-blue-500/50 rounded-xl p-4 mb-6">
            <div className="flex items-start space-x-3">
              ...
              <div>
                <h3 className="text-blue-300 font-medium text-sm mb-1">Developed by BilalTM</h3>
          ...
          <div className="mt-8 text-center text-xs text-gray-500">
            ...
            <p className="mt-1">
              <a href="#" className="hover:underline">Gizlilik Politikası</a> ve{' '}
              <a href="#" className="hover:underline">Hizmet Şartları</a> geçerlidir.
            </p>
          </div>
        </div>
      </div>
